  ...
  projects: [
    {
      title: '',
      entities: [
        {x: 4, y: 3, width: 4, height: 16, _type: "image", src: "https://pbs.twimg.com/profile_images/844519182024761349/SBh9U9bN.jpg", alt: "A banner image from the storefront" },
        {x: 3, y: 0, width: 6, height: 2, _type: "text", text: "Fora 42 Berners St Moodboard."},
        // {x: 5, y: 1, width: 2, height: 9, _type: "product", img: { src: "http://mos.oddberries.com/wp-content/uploads/2018/08/serena-rame-front-1-768x767.jpg", alt: "" }, title: "Serena", design: "Patricia Urquiola / FLOS", price: "£729-£1528" },
        // {x: 3, y: 1, width: 2, height: 7, _type: "material", img: { src: "https://matterofstuff.com/wp-content/uploads/2019/05/material-rawearth-fuga-matteobrioni-matterofstuff20180910_0553.jpg", alt: "" }, title: "Fuga", design: "TerraTon" },
        // {x: 4, y: 10, width: 2, height: 2, _type: "colour", hex: "9a95b5" },
        // {x: 0, y: 0, width: 2, height: 6, _type: "file", format: "pdf", name: "History of Italian Design", image: { src: "https://cdn.shopify.com/s/files/1/1709/9537/products/100977_1024x1024.jpg?v=1508977616" } },
    ...
    },
    {
      ...
      entities: [
        {x: 0, y: 0, width: 12, height: 19, _type: "image", src: "https://matterofstuff.com/wp-content/uploads/2018/09/our-curated-design-shop-2000x944.jpg", alt: "A banner image from the storefront" },
      ]
    },
    {
      title: 'Page Two',
      entities: [
        {x: 3, y: 1, width: 6, height: 3, _type: "text", text: "Shapes and Inspiration"},
        {x: 1, y: 6, width: 2, height: 10, _type: "image", src: "https://cdn.mos.cms.futurecdn.net/U4BRsKHqqUrs3wcXVY49ub-768-80.jpg", alt: "A banner image from the storefront" },
        {x: 3, y: 6, width: 4, height: 10, _type: "image", src: "https://matterofstuff.com/wp-content/uploads/2018/09/our-curated-design-shop-2000x944.jpg", alt: "A banner image from the storefront" },
        {x: 7, y: 6, width: 4, height: 10, _type: "image", src: "https://matterofstuff.com/wp-content/uploads/2018/09/our-curated-design-shop-2000x944.jpg", alt: "A banner image from the storefront" },
    ...
    },
    {
      ...
      entities: [
        {x: 3, y: 1, width: 6, height: 3, _type: "text", text: "Shapes and Inspiration"},
        {x: 0, y: 4, width: 12, height: 13, _type: "image", src: "https://www.luxurylifestylemag.co.uk/wp-content/uploads/2019/08/19-0124151-IG-Creative-Collaboration.jpg", alt: "A banner image from the storefront" },
        {x: 0, y: 19, width: 1, height: 1, _type: "image", src: "", alt: "A banner image from the storefront" },
      ]
    },
    {
      title: 'Page Four',
      entities: [
        {x: 0, y: 3, width: 4, height: 13, _type: "image", src: "https://www.extreme-design.co.uk/wp-content/uploads/2019/07/kitchen-design-trend-2019-colour-blocking-and-geometric-interior.jpg", alt: "A banner image from the storefront" },
        {x: 4, y: 3, width: 4, height: 13, _type: "image", src: "https://www.interiorsandsources.com/Portals/0/Images/2018-August/2020-trends/IS_SHAW_CALPE_2019_RGB.jpg", alt: "A banner image from the storefront" },
        {x: 8, y: 3, width: 4, height: 13, _type: "image", src: "https://de-production-media.s3.amazonaws.com/loft/3958/Moody_Colors.jpg", alt: "A banner image from the storefront" },
        {x: 0, y: 19, width: 1, height: 1, _type: "image", src: "", alt: "A banner image from the storefront" },
      ]
    },
    {
      title: 'Page Five',
      entities: [
        {x: 3, y: 0, width: 6, height: 3, _type: "text", text: "Shample Board"},
        {x: 2, y: 4, width: 8, height: 15, _type: "image", src: "https://lodgingmagazine.com/wp-content/uploads/2019/05/Inclusivity_Palette_HR.jpg", alt: "A banner image from the storefront" },
        {x: 0, y: 19, width: 1, height: 1, _type: "image", src: "", alt: "A banner image from the storefront" },
      ]
    },
    {
    ...
    },
    {
      title: 'Page Seven',
      entities: [
        {x: 3, y: 0, width: 6, height: 3, _type: "text", text: "Colour Moodboard"},
        {x: 1, y: 4, width: 3, height: 15, _type: "image", src: "https://essentialhome.eu/inspirations/wp-content/uploads/2018/08/Untitled-design-740x560.png", alt: "A banner image from the storefront" },
        {x: 4, y: 4, width: 4, height: 15, _type: "image", src: "https://www.livesouthshore.com/wp-content/uploads/ppg-color-of-the-year-2019-01.jpg", alt: "A banner image from the storefront" },
        {x: 8, y: 4, width: 3, height: 15, _type: "image", src: "https://cdn.interiorzine.com/wp-content/uploads/2018/02/interior-design-color-trends-2019-79.jpg", alt: "A banner image from the storefront" },
        {x: 0, y: 19, width: 1, height: 1, _type: "image", src: "", alt: "A banner image from the storefront" },
      ]
    },
    {
      ...
      entities: [
        {x: 0, y: 0, width: 3, height: 3, _type: "text", text: "Roll out early Jully"},
        ...
        {x: 8, y: 1, width: 4, height: 6, _type: "image", src:  "https://www.elreytuqueque.com/wp-content/uploads/2018/07/interior-design-trends-for-autumn-2017-that-are-out-in-2018-winter-7-top-home-improvement-glamorous.jpg", alt: "A banner image from the storefront" },
    ...
    },
    {
      ...
      entities: [
        ...
        {x: 6, y: 4, width: 6, height: 7, _type: "image", src:  "https://www.bauline.it/wp/wp-content/uploads/2016/07/Tavolo-bauline-minuetto-4-800x549.jpg", alt: "A banner image from the storefront" },
        {x: 6, y: 11, width: 6, height: 7, _type: "image", src:  "https://www.bauline.it/wp/wp-content/uploads/2016/07/Tavolo-bauline-minuetto-6-800x539.jpg", alt: "A banner image from the storefront" },
        {x: 3, y: 4, width: 3, height: 14, _type: "image", src:  "https://www.bauline.it/wp/wp-content/uploads/2016/07/Tavolo-bauline-minuetto-2-800x655.jpg", alt: "A banner image from the storefront" },
